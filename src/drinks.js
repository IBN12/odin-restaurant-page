...
function AddCurrentModuleContent(){
    ...
    drinkItemImageOne.src = '../src/images/Sparkling-Water.png';
    ...
    drinkItemImageTwo.src = '../src/images/Ginger-Ale.png';
    ...
    drinkItemImageThree.src = '../src/images/Niepoort-Ruby-Port-Wine.png';
    ...
    drinkItemImageFour.src = '../src/images/Red-Wine.png';
    ...
    drinkItemImageFive.src = '../src/images/Soda.png';
    ...
    drinkItemImageSix.src = '../src/images/Milk-Shake.png';
